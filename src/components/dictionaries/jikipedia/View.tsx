...
import {
  JikipediaSearchResult,
  _JikipediaSearchResult,
  parseSearchResult
} from './engine'
import { StrElm } from '@/components/StrElm'

export const Jikipedia: FC<ViewPorps<
  _JikipediaSearchResult<string>
>> = props => {
  const [
    parsedResult,
    setParsedResult
  ] = React.useState<JikipediaSearchResult | null>(null)
